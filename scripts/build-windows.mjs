...
function writePortableReadme(destDir, arch) {
  ...
  const contents = [
    ...
    '',
    'If the window opens but loading spinner never ends',
    '- Fixed in recent builds: unpackaged AsyncStorage needs a LocalAppData DB path.',
    '- Rebuild from latest main if you still see infinite loading.',
    '',
    'Notes',
